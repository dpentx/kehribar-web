...
export const translations = {
  tr: {
    ...
    'back': 'Geri',
    'cmdk-placeholder': 'Bir sayfa ara...',
    'cmdk-empty': 'Sonuç yok',
    'cmdk-hint-nav': 'gezin',
    'cmdk-hint-select': 'seç',
    'cmdk-hint-close': 'kapat',
    'jump-to': 'Git',
    'theme-label': 'true-black',
    'rss-label': 'rss',
  },
  en: {
    'nav-home': 'Home',
    ...
    'read-more': 'Read more',
    'back': 'Back',
    'cmdk-placeholder': 'Search a page...',
    'cmdk-empty': 'No results',
    'cmdk-hint-nav': 'navigate',
